...
setInterval(()=>{ //simulate a new customer order
  ...
  eventEmitter.emit('pickup', custOrder); //Emit a ‘pickup’ event and attach the fake order as payload
}, 5000); //Every 5 seconds

eventEmitter.on('delivered', thanks); //Whenever the ‘delivered’ event occurs
